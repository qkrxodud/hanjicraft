  ...
  ko: {
    ...
    hero: {
      ...
      slide2: {
        title: '천년의 기술, 현대의 미학',
        description:
          '닥나무 껍질에서 시작된 한 장의 종이가 장인의 손에서 빛나는 예술 작품으로 완성됩니다.',
      },
      slide3: {
        title: '자연에서 온 아름다움',
        description:
    ...
    philosophy: {
      label: '紙',
      quote:
        '천년의 시간이 한 장의 종이에 깃들고,\n장인의 손끝에서 새로운 아름다움이 피어납니다.',
    },
    highlights: {
      title: '메종 오브제 출품작',
      exhibition: {
        category: '2026 메종 오브제',
        title: '한지 모시 무드등',
        description: '한지와 모시를 엮어 만든 전통소재 기반의 은은한 조명 오브제',
        link: '자세히 보기',
      },
      collection: {
        category: '2026 메종 오브제',
        title: '모시 풍경',
        description: '모시의 우아한 실루엣 끝에서 울리는 청아한 종소리',
        link: '자세히 보기',
      },
      workshop: {
        category: '2026 메종 오브제',
        title: '한지 모시 티코스터',
        description: '전통 오방색에 은은한 무드를 더한 한지와 모시를 결합한 티코스터',
        link: '자세히 보기',
      },
    },
    brand: {
      ...
      mission: {
        title: '우리의 미션',
        description:
          '천년의 전통 한지 기법을 현대적 감각으로 재해석하여 일상 속에서 누릴 수 있는 아름다운 오브제를 만듭니다.',
      },
      vision: {
        title: '브랜드 비전',
        description:
          '한국의 정체성이 담긴 전통 공예를 세계무대에 알리며, 지속가능한 소재와 장인정신을 바탕으로 한 라이프스타일 브랜드를 지향합니다.',
      },
      values: {
        title: '핵심 가치',
        tradition: {
          title: '전통 오방색 활용',
          description:
            '동·서·남·북과 중앙을 상징하는 오방색을 활용해 한지에 전통적 의미와 미감을 담아냅니다.',
        },
        innovation: {
          title: '현대적 혁신',
          description:
            '전통 기법에 현대적 디자인과 기술을 접목하여 새로운 가치를 창조합니다.',
        },
        sustainability: {
          title: '지속가능성',
          description: '한지 모시 옻칠등 자연에서 온 전통재료를 사용합니다.',
        },
        craftsmanship: {
          title: '장인정신',
          description:
            '디자인 전공자로서의 시각과 오랜 시간 다져온 공예 기술을 더합니다.',
        },
      },
    },
    collection: {
      title: '제작 과정',
      modern: { title: '티코스터, 무드등 제작', description: '천연풀로 모시와 한지를 단단하게 결합합니다.' },
      techniques: { title: '티코스터 제작', description: '원형으로 잘라서 모시와 한지를 붙입니다.' },
      forming: { title: '모시풍경 제작', description: '모시조각으로 모양을 만듭니다.' },
      materials: { title: '모시풍경 제작', description: '바느질한 모시모형에 종과 매듭을 잇습니다.' },
      tools: { title: '모시한지무드등 제작', description: '모시와 한지가 결합된 것을 길게자릅니다.' },
      beating: { title: '모시한지무드등 제작', description: '잘라진 모시+한지로 모양을 만듭니다.' },
      preparation: { title: '모시한지무드등 제작', description: 'LED전구를 고정합니다.' },
      soaking: { title: '모시한지무드등 제작', description: '무드등을 완성합니다.' },
    },
    masterpieces: {
      title: '갤러리',
      lamp: {
        title: '오방색과 모란의 조화를 담은 자수함',
        description: '한국전통의 오방색과 풍요를 상징하는 모란꽃을 모티브',
        period: '작은 실타래 하나도 소중히 간직하는 한국의 정서(자수함)',
      },
      vessels: { title: '찻상(명상/우담바라를 기다리며)', period: '3천년에 한번피는 우담바라꽃을 모티브' },
      daily: { title: '경상도골무문 테이블웨어', period: '한지와 모시 그리고 옻칠마감' },
      art: { title: '마음을 담는 보석함', period: '모란문양의 한국전통 패물함' },
      architecture: { title: '무드등(염원:기원의 빛)', period: '모란문양과 정갈한 조각들이 나타내는 소원' },
      drawer: { title: '장무상망(Eternal Remembrance)', period: '오래도록 서로 잊지말자는 약속을 담은 오브제' },
    ...
    featured: {
      ...
      armor: {
        ...
        period: '불교의식용 다기',
        description:
          '전통 한지 지승줄을 정성스럽게 감아 형태를 만들고, 그 위에 천연 옻칠로 마감하여 견고함과 깊은 색감을 더한 불교 의식용 다기입니다.',
        link: '자세히 보기',
      },
      craftsman: {
        title: '지승(紙繩)풍경',
        ...
        description:
          '전통 지승 공예로 엮은 구슬 위에 단청의 화려하고 단아한 색채를 입힌 동자승을 얹어 만든 풍경입니다.',
        link: '자세히 보기',
      },
    },
    footer: {
  ...
  en: {
    ...
    hero: {
      ...
      slide2: {
        ...
        description:
          'From mulberry bark to luminous form — each piece carries the weight of centuries and the touch of a master\'s hand.',
      },
      slide3: {
    ...
    philosophy: {
      label: 'PAPER',
      quote:
        'A thousand years dwell within a single sheet of paper,\nand from the artisan\'s hands, new beauty blossoms.',
    },
    highlights: {
    ...
    brand: {
      ...
      mission: {
        title: 'Our Mission',
        description:
          'We reinterpret thousand-year-old traditional hanji techniques with contemporary sensibility to create beautiful objects for everyday life.',
      },
      vision: {
        title: 'Brand Vision',
        description:
          'We aim to introduce traditional Korean crafts with cultural identity to the world stage, becoming a lifestyle brand based on sustainable materials and craftsmanship.',
      },
      values: {
        title: 'Core Values',
        tradition: {
          title: 'Heritage Preservation',
          description: 'We preserve and pass down hanji-making techniques that have been practiced for over 1,000 years.',
        },
        innovation: {
          title: 'Modern Innovation',
          description: 'We create new value by combining traditional techniques with contemporary design and technology.',
        },
        sustainability: {
    ...
    collection: {
      title: 'Craft Process',
      modern: { title: 'Tea Coaster, Mood Lamp Production', description: 'Firmly combining ramie and hanji with natural glue.' },
      techniques: { title: 'Tea Coaster Production', description: 'Cut into circles and attach ramie and hanji.' },
      forming: { title: 'Ramie Wind Bell Production', description: 'Creating shapes with ramie pieces.' },
      materials: { title: 'Ramie Wind Bell Production', description: 'Connecting bells and knots to sewn ramie forms.' },
      tools: { title: 'Ramie Hanji Mood Lamp Production', description: 'Cut the combined ramie and hanji into long pieces.' },
      beating: { title: 'Ramie Hanji Mood Lamp Production', description: 'Create shapes with cut ramie + hanji.' },
      preparation: { title: 'Ramie Hanji Mood Lamp Production', description: 'Fix the LED bulb.' },
      soaking: { title: 'Ramie Hanji Mood Lamp Production', description: 'Complete the mood lamp.' },
    },
    masterpieces: {
      title: 'Gallery',
      lamp: {
      ...
      vessels: { title: 'Tea Table (Meditation/Waiting for Udumbara)', period: 'Motif of udumbara flower that blooms once in 3,000 years' },
      daily: { title: 'Gyeongsang-do Thimble Pattern Tableware', period: 'Hanji and ramie with lacquer finish' },
      art: { title: 'Jewelry Box that Holds the Heart', period: 'Traditional Korean accessory box with peony pattern' },
      architecture: { title: 'Mood Lamp (Wish: Light of Prayer)', period: 'Wishes represented by peony patterns and neat sculptures' },
      drawer: { title: 'Eternal Remembrance', period: 'Object containing the promise not to forget each other for a long time' },
    ...
    featured: {
      ...
      armor: {
        ...
        description: 'Buddhist ceremonial tea set made by carefully winding traditional hanji jiseung rope to create the form and finishing with natural lacquer for durability and deep color.',
        link: 'View Details',
      },
      craftsman: {
        title: 'Jiseung (Paper Rope) Wind Chime',
        period: 'Thousand-year paper, jiseung (paper rope) wind chime made by twisting hanji',
        description: 'A wind chime made by placing a novice monk painted with the colorful and elegant colors of dancheong on beads woven with traditional jiseung craft.',
        link: 'View Details',
      },
    },
    footer: {
  ...
  fr: {
    ...
    hero: {
      ...
      slide2: {
        ...
        description:
          "De l'écorce de mûrier à la forme lumineuse — chaque pièce porte le poids des siècles et la main du maître artisan.",
      },
      slide3: {
    ...
    brand: {
      ...
      mission: {
        title: 'Notre Mission',
        description:
          "Nous réinterprétons les techniques traditionnelles du hanji vieilles de mille ans avec une sensibilité contemporaine pour créer de beaux objets du quotidien.",
      },
      vision: {
        title: 'Vision de la Marque',
        description:
          "Nous visons à faire découvrir les artisanats traditionnels coréens avec leur identité culturelle sur la scène mondiale.",
      },
      values: {
        title: 'Valeurs Fondamentales',
        tradition: {
          title: 'Préservation du Patrimoine',
          description: 'Nous préservons et transmettons les techniques de fabrication du hanji pratiquées depuis plus de 1 000 ans.',
        },
        innovation: {
          title: 'Innovation Moderne',
          description: 'Nous créons une nouvelle valeur en combinant les techniques traditionnelles avec le design et la technologie contemporains.',
        },
        sustainability: {
          title: 'Durabilité',
    ...
    collection: {
      ...
      modern: { title: "Production de Sous-verres à Thé, Lampe d'Ambiance", description: 'Combiner fermement le ramie et le hanji avec de la colle naturelle.' },
      techniques: { title: 'Production de Sous-verres à Thé', description: 'Couper en cercles et attacher le ramie et le hanji.' },
      forming: { title: 'Production de Paysage de Ramie', description: 'Créer des formes avec des pièces de ramie.' },
      materials: { title: 'Production de Paysage de Ramie', description: 'Connecter les cloches et les nœuds aux formes de ramie cousues.' },
      tools: { title: "Production de Lampe d'Ambiance Ramie-Hanji", description: 'Couper le ramie et le hanji combinés en longs morceaux.' },
      beating: { title: "Production de Lampe d'Ambiance Ramie-Hanji", description: 'Créer des formes avec le ramie + hanji coupé.' },
      preparation: { title: "Production de Lampe d'Ambiance Ramie-Hanji", description: "Fixer l'ampoule LED." },
      soaking: { title: "Production de Lampe d'Ambiance Ramie-Hanji", description: "Compléter la lampe d'ambiance." },
    },
    masterpieces: {
      title: 'Galerie',
      lamp: {
      ...
      vessels: { title: "Table à Thé (Méditation/En Attendant l'Udumbara)", period: "Motif de la fleur d'udumbara qui fleurit une fois en 3 000 ans" },
      daily: { title: 'Vaisselle à Motif de Dé Gyeongsang-do', period: 'Hanji et ramie avec finition laque' },
      art: { title: 'Boîte à Bijoux qui Porte le Cœur', period: 'Boîte à accessoires traditionnelle coréenne avec motif de pivoine' },
      architecture: { title: "Lampe d'Ambiance (Souhait : Lumière de Prière)", period: 'Souhaits représentés par les motifs de pivoine et sculptures soignées' },
      drawer: { title: 'Souvenir Éternel', period: "Objet contenant la promesse de ne pas s'oublier longtemps" },
    ...
    featured: {
      ...
      armor: {
        ...
        description: "Service à thé cérémoniel bouddhiste fait en enroulant soigneusement la corde jiseung hanji traditionnelle pour créer la forme et en finissant avec de la laque naturelle.",
        link: 'Voir les Détails',
      },
      craftsman: {
        ...
        description: "Un carillon éolien fait en plaçant un moine novice peint avec les couleurs colorées et élégantes du dancheong sur des perles tissées avec l'artisanat jiseung traditionnel.",
        link: 'Voir les Détails',
      },
    },
    footer: {
